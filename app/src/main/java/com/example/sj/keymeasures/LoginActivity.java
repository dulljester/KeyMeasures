...
/**
 * A standard Login activity that showcases the use of Firebase
 * Honestly, just stole this from the internet
 */
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animatedVectorDrawable= logoImageView.getDrawable();
